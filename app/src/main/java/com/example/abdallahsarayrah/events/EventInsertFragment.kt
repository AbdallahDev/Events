 ...
 */
class EventInsertFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        var url = "http://192.168.0.29/android/android_events/web_apis/committees_get.php?directorateId=${Users.userDirectorate}&committeeId=${Users.userDirectorate}"
        ...
        editTextEventInsertEventEntityName.addTextChangedListener(object : TextWatcher {
        ...
        url = "http://192.168.0.29/android/android_events/web_apis/halls_get.php"
        ...
        textViewEventInsertCreate.setOnClickListener {
            ...
            val url = "http://192.168.0.29/android/android_events/web_apis/event_insert.php?committeeId=$committeeId&eventEntityName=$eventEntityName&eventTime=${Events.hour}:${Events.minute}&subject=${editTextEventInsertEventSubject.text}&event_date=${Events.year}-${Events.month + 1/* +1 to the month because the date picker return the month with a value minus one, ex: december = 11 */}-${Events.day}&hall_id=$hallId"
